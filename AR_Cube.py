...
frame = cv2.VideoCapture('util/input_videos/Tag0.mp4')
count = 0
success = 1
images=[]
...
while (success):
    ...
    # ================= Displaying tag through homography ================== #
...
def video(images,size):
    video=cv2.VideoWriter('output_video_cube.avi',cv2.VideoWriter_fourcc(*'DIVX'), 16.0,size)
